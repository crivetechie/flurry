...
class Client(Iface):
  ...
  def get_id_detailed(self):
    self.send_get_id_detailed()
    return self.recv_get_id_detailed()

  def send_get_id_detailed(self):
    self._oprot.writeMessageBegin('get_id_detailed', TMessageType.CALL, self._seqid)
    args = get_id_detailed_args()
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_get_id_detailed(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      ...
      iprot.readMessageEnd()
      raise x
    result = get_id_detailed_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "get_id_detailed failed: unknown result");
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["get_id_detailed"] = Processor.process_get_id_detailed
  ...
  def process_get_id_detailed(self, seqid, iprot, oprot):
    args = get_id_detailed_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = get_id_detailed_result()
    result.success = self._handler.get_id_detailed()
    oprot.writeMessageBegin("get_id_detailed", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class get_id_detailed_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('get_id_detailed_args')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class get_id_detailed_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (IdDetailed, IdDetailed.thrift_spec), None, ), # 0
  )
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('get_id_detailed_result')
    if self.success is not None:
